<div class="modal fade" id="pengalamanModal" tabindex="-1" aria-labelledby="pengalamanModal" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="/submit-pengalaman" method="POST" class="form-validate" novalidate>
                @csrf
