                ...
                <div class="modal-body min-vh-50 scroll-modal p-4">
                    ...
                    <div class="my-2 p-2 row d-flex justify-content-evenly">
                        ...
                        <div class="col-lg-6 my-2">
                            ...
                            <div class="col-10">
                                <select name="bulan_mulai" id="bulan_mulai_pengalaman" class="form-select" required>
                        ...
                        <div class="col-lg-6 my-2">
                            ...
                            <div class="col-10">
                                <select name="tahun_mulai" class="form-select" id="tahun_mulai_pengalaman" required>
                    ...
                    <div class="my-2 p-2 row d-flex justify-content-evenly">
                        ...
                        <div class="col-lg-6 my-2">
                            ...
                            <div class="col-10">
                                <select name="bulan_selesai" id="bulan_selesai_pengalaman"
                        ...
                        <div class="col-lg-6 my-2">
                            ...
                            <div class="col-10">
                                <select name="tahun_selesai" id="tahun_selesai_pengalaman"
                                    class="form-select end-date">
                    ...
                    <div class="my-3">
                        ...
                        <textarea name="deskripsi_pengalaman" id="deskripsi" cols="30" rows="5" class="form-control"></textarea>
                    </div>
